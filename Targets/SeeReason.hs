...
targets _home =
    [ Target { sourcePackageName = "autobuilder"
             ...
             , relaxInfo = [] }
    , Target { sourcePackageName = "happstack-debianization"
             , sourceSpec = "darcs:http://src.seereason.com/happstack-debianization"
             , relaxInfo = [] }
    ...
    , Target { sourcePackageName = "haskell-unixutils"
             , sourceSpec = "darcs:" ++ repo ++ "/haskell-unixutils"
             , relaxInfo = [] }
