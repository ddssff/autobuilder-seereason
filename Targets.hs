...
--  won't build.  Use our debianization instead.
    ...
    , Target { sourcePackageName = "haskell-hjavascript"
             , sourceSpec = "deb-dir:(uri:http://hackage.haskell.org/packages/archive/HJavaScript/0.4.5/HJavaScript-0.4.5.tar.gz:ba43efb72df03334cedbc9b38e948db0):(darcs:http://src.seereason.com/hjavascript-debian)"
             , relaxInfo = [] }
    , Target { sourcePackageName = "haskell-hjscript"
             , sourceSpec = "deb-dir:(uri:http://hackage.haskell.org/packages/archive/HJScript/0.4.7/HJScript-0.4.7.tar.gz:14f902f78bb363acd4337cd00518297c):(darcs:http://src.seereason.com/hjscript-debian)"
             , relaxInfo = [] }      
