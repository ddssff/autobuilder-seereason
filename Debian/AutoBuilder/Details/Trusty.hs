...
module Debian.AutoBuilder.Details.Trusty( buildTargets, commonTargets ) where
...
import Debian.AutoBuilder.Details.Common hiding (ghcjs, ghcjs_also) -- (named, ghcjs_flags, putSrcPkgName)
...
commonTargets = do
  ...
  --------------------------------------------------
  _abstract_deque <-  hackage (Just "0.3") "abstract-deque" >>= debianize [] {->>= setDebVersion-}
  ...
  _ansi_terminal <- hackage (Just "0.6.2.3") "ansi-terminal" >>= debianize [] >>= ghcjs_also
  _ansi_wl_pprint <- hackage (Just "0.6.7.3") "ansi-wl-pprint" >>= debianize [] >>= ghcjs_also
  ...
  _asn1_parse <-  (hackage (Just "0.9.4") "asn1-parse") >>= debianize [] >>= inGroups ["authenticate", "important"] >>= ghcjs_also
  _asn1_types <-  (hackage (Just "0.3.2") "asn1-types") >>= debianize [] >>= ghcjs_also
  ...
  _base16_bytestring <-  (hackage (Just "0.1.1.6") "base16-bytestring") >>= debianize [] >>= ghcjs_also
  _base64_bytestring <-  (hackage (Just "1.0.0.1") "base64-bytestring" >>= tflag (P.DebVersion "1.0.0.1-1")) >>= debianize [] >>= inGroups ["happstack", "important"] >>= ghcjs_also
  ...
  _byteable <-  (hackage (Just "0.1.1") "byteable" >>= tflag (P.DebVersion "0.1.1-1")) >>= debianize [] >>= ghcjs_also
  ...
  _bzlib <-  (hackage (Just "0.5.0.5") "bzlib" >>= flag (P.DevelDep "libbz2-dev")) >>= debianize [] >>= ghcjs_also
...
-}
  ...
  _comfort_graph <- hackage (Just "0.0.1") "comfort-graph" >>= debianize [] >>= ghcjs_also >>= skip (Reason "transformers dependency too old")
  ...
  _connection <-  (hackage (Just "0.2.5") "connection") >>= debianize [] >>= inGroups ["conduit", "important"] >>= ghcjs_also
  ...
  _crypto_api <-  (hackage (Just "0.13.2") "crypto-api" >>= qflag (P.DebVersion "0.10.2-1build3")) >>= debianize [] >>= ghcjs_also
  ...
  _cryptohash_conduit <-  (hackage (Just "0.1.1") "cryptohash-conduit") >>= debianize [] >>= inGroups ["servant"] >>= ghcjs_also
  ...
  _data_default_instances_containers <-  (hackage (Just "0.0.1") "data-default-instances-containers") >>= debianize [] >>= ghcjs_also
  _data_default_instances_dlist <-  (hackage (Just "0.0.1") "data-default-instances-dlist") >>= debianize [] >>= ghcjs_also
  _data_default_instances_old_locale <-  (hackage (Just "0.0.1") "data-default-instances-old-locale") >>= debianize [] >>= ghcjs_also
  _data_lens <- hackage (Just "2.10.7") "data-lens" {-`patch` $(embedFile "patches/data-lens.diff")-} >>= debianize [] >>= ghcjs_also >>= skip (Reason "Unmet build dependencies: libghcjs-comonad-dev (<< 4.3) libghcjs-semigroupoids-dev (<< 5.1)")
  ...
  _digest <-  (hackage (Just "0.0.1.2") "digest") >>= debianize [] >>= ghcjs_also
  ...
  _easy_file <-  (hackage (Just "0.2.1") "easy-file") >>= debianize [] >>= ghcjs_also
  ...
  _entropy <-  (hackage (Just "0.3.7") "entropy") >>= debianize [] >>= ghcjs_also
  ...
  _fmlist <-  (hackage (Just "0.9") "fmlist") >>= debianize [] >>= ghcjs_also
  _foreign_var <-  (hackage (Just "0.1") "foreign-var") >>= debianize [] >>= ghcjs_also >>= skip (Reason "dependencies")
  ...
  _ghcjs_base <- git "https://github.com/ghcjs/ghcjs-base" [] >>= debianize [] >>= ghcjs -- causes double --ghcjs to be passed to cabal-debian
  ...
  _ghcjs_ffiqq <- git "https://github.com/ghcjs/ghcjs-ffiqq" [] >>= putSrcPkgName "ghcjs-ghcjs-ffiqq" >>= debianize [] >>= ghcjs_also >>= skip (Reason "[libghc-ghcjs-base-doc] -> []")
  ...
  _ghcjs_dom_hello <- hackage (Just "3.0.0.0") "ghcjs-dom-hello" >>=
                      ...
                      debianize [] >>=
                      inGroups ["glib"] >>= ghcjs >>=
                      skip0 (Reason "see cairo and glib")
  ...
  _hamlet <-  (hackage (Just "1.2.0") "hamlet") >>= debianize [] >>= ghcjs_also >>= skip (Reason "No input files to haddock?")
  ...
  _happstack_server <- git "https://github.com/Happstack/happstack-server"
                           -- Should be version 7.4.7
                           [Commit "3e3ef7518f697bad5243b87a46459ae31a125812"] >>=
  ...
  _haXml <- {-git "https://github.com/ddssff/HaXml" []-} hackage (Just "1.25.3") "HaXml" >>= debianize [] >>= inGroups ["pretty"] >>= ghcjs_also
  ...
  _hostname <- hackage (Just "1.0") "hostname"
                              ...
                              >>= tflag (P.DebVersion "1.0-6") >>= debianize [] >>= ghcjs_also
  ...
  _hslua <-  (hackage (Just "0.4.1") "hslua") >>= debianize [] >>= inGroups ["happstack", "important"] >>= ghcjs_also
  ...
  _hspec_expectations <-  (hackage (Just "0.7.2") "hspec-expectations") >>= debianize [] >>= ghcjs_also
  ...
  _html <-  (hackage (Just "1.0.1.2") "html"
                             ...
                             >>= pflag (P.DebVersion "1.0.1.2-5")) >>= debianize [] >>= inGroups ["platform"] >>= ghcjs_also
  ...
  _http_types <-  (hackage (Just "0.8.6") "http-types" >>= flag (P.CabalPin "0.8.6")) >>= debianize [] >>= inGroups ["happstack", "important"] >>= ghcjs_also -- web-routes specifies << 0.9
  ...
  _hxt_charproperties <-  (hackage (Just "9.2.0.1") "hxt-charproperties") >>= debianize [] >>= ghcjs_also
  _hxt <-  (hackage (Just "9.3.1.15") "hxt" >>= flag (P.CabalDebian ["--cabal-flags", "network-uri"])) >>= debianize [] >>= ghcjs_also
  _hxt_regex_xmlschema <-  (hackage (Just "9.2.0.2") "hxt-regex-xmlschema") >>= debianize [] >>= ghcjs_also
  _hxt_unicode <-  (hackage (Just "9.0.2.4") "hxt-unicode") >>= debianize [] >>= ghcjs_also
  ...
  _js_flot <-  (hackage (Just "0.8.3") "js-flot") >>= debianize [] >>= ghcjs_also
  _js_jquery <-  (hackage (Just "3.1.0") "js-jquery") >>= debianize [] >>= ghcjs_also
  _jsaddle <- git "https://github.com/ghcjs/jsaddle" [] >>= debianize [] >>= ghcjs_also >>= skip (Reason "Unmet build dependencies: libghcjs-lens-dev (<< 4.15)")
  _json <-  (hackage (Just "0.9.1") "json") >>= debianize [] >>= inGroups ["seereason", "important"] >>= ghcjs_also -- darcs "haskell-json" (repo ++ "/haskell-json")
  _juicyPixels <- hackage (Just "3.2.8") "JuicyPixels" >>= patch $(embedFile "patches/JuicyPixels.diff") >>= debianize [] >>= inGroups ["happstack", "important"] >>= ghcjs_also
...
-}
  ...
  _logict <- createPackage (Debianize'' (Hackage "logict") Nothing) mempty [] >>= ghcjs_also
  ...
  _network_info <-  (hackage (Just "0.2.0.8") "network-info") >>= debianize [] >>= ghcjs_also
  ...
  _old_locale <- hackage (Just "1.0.0.7") "old-locale" >>= patch $(embedFile "patches/old-locale.diff") >>= debianize [] >>= ghcjs_also
  _old_time <- hackage (Just "1.1.0.3") "old-time" >>= patch $(embedFile "patches/old-time.diff") >>= debianize [] >>= ghcjs_also
  ...
  _pcre_light <- hackage (Just "0.4.0.4") "pcre-light" >>=
                 ...
                 debianize [] >>=
                 ghcjs_also
  _pem <-  (hackage (Just "0.2.2") "pem") >>= debianize [] >>= inGroups ["authenticate", "important"] >>= ghcjs_also
  ...
  _random <-  (hackage (Just "1.1") "random" >>= flag (P.SkipVersion "1.0.1.3")) >>= debianize [] >>= inGroups ["platform"] >>= ghcjs_also -- 1.1.0.3 fixes the build for ghc-7.4.2 / base < 4.6
  ...
  _regex_base <-  (hackage (Just "0.93.2") "regex-base"
                             ...
                             >>= pflag (P.DebVersion "0.93.2-2")) >>= debianize [] >>= inGroups ["platform"] >>= ghcjs_also
  _regex_compat <-  (hackage (Just "0.95.1") "regex-compat"
                             >>= pflag (P.DebVersion "0.95.1-2")
                             >>= tflag (P.DebVersion "0.95.1-4")) >>= debianize [] >>= inGroups ["platform"] >>= ghcjs_also
  ...
  _regex_posix <-  (hackage (Just "0.95.2") "regex-posix" >>= tflag (P.DebVersion "0.95.2-3")) >>= debianize [] >>= inGroups ["platform"] >>= ghcjs_also
  ...
  _safe <-  (hackage (Just "0.3.9") "safe") >>= debianize [] >>= ghcjs_also
  ...
  _sendfile <-  (hackage (Just "0.7.9") "sendfile" >>= tflag (P.DebVersion "0.7.9-1")) >>= debianize [] >>= ghcjs_also
  ...
  _setenv <-  (hackage (Just "0.1.1.3") "setenv") >>= debianize [] >>= ghcjs_also
  _set_extra <-  (darcs ("http://src.seereason.com/set-extra")) >>= debianize [] >>= ghcjs_also
  ...
  _sha <-  (hackage (Just "1.6.4.2") "SHA") >>= debianize [] >>= ghcjs_also -- apt (rel release "wheezy" "quantal") "haskell-sha"
  _shake <-  (hackage (Just "0.15.10") "shake") >>= debianize [] >>= ghcjs_also >>= skip (Reason "dependencies")
  ...
  _smallcheck <-  (hackage (Just "1.1.1") "smallcheck") >>= debianize [] >>= ghcjs_also
  ...
  _sodium <- hackage (Just "0.11.0.3") "sodium" >>= debianize [] >>= ghcjs_also >>= skip (Reason "dependencies")
  ...
  _syb_with_class_instances_text <-
                  (hackage (Just "0.0.1") "syb-with-class-instances-text"
                              ...
                              >>= tflag (P.DebVersion "0.0.1-6build1")) >>= debianize [] >>= ghcjs_also >>= broken
  _system_fileio <-  (hackage (Just "0.3.16.3") "system-fileio") >>= debianize []
  _system_filepath <-  (hackage (Just "0.4.13.4") "system-filepath") >>= debianize [] >>= ghcjs_also
  ...
  _tasty_smallcheck <-  (hackage (Just "0.8.1") "tasty-smallcheck") >>= debianize [] >>= ghcjs_also
  ...
  _test_framework <- hackage (Just "0.8.1.1") "test-framework" >>= patch $(embedFile "patches/test-framework.diff") >>= debianize [] >>= ghcjs_also
  _test_framework_hunit <-  (hackage (Just "0.3.0.2") "test-framework-hunit") >>= debianize [] >>= ghcjs_also
  _test_framework_quickcheck2 <- git "https://github.com/seereason/test-framework" [] >>= patch $(embedFile "patches/test-framework-quickcheck2.diff") >>= cd "quickcheck2" >>= debianize [] >>= ghcjs_also
  ...
  _text_binary <- hackage (Just "0.2.1") "text-binary" >>= debianize [] >>= ghcjs_also
  ...
  _tf_random <-  (hackage (Just "0.5") "tf-random") >>= debianize [] >>= inGroups ["platform"] >>= ghcjs_also
  ...
  _time_compat <-  (hackage (Just "0.1.0.3") "time-compat") >>= debianize [] >>= inGroups ["happstack", "important"] >>= ghcjs_also
  ...
  _transformers_base <- hackage (Just "0.4.4") "transformers-base" >>= debianize [] >>= ghcjs_also
  ...
  _unbounded_delays <-  (hackage (Just "0.1.0.9") "unbounded-delays") >>= debianize [] >>= ghcjs_also
  ...
  _uniplate <-  (hackage (Just "1.6.12") "uniplate") >>= debianize [] >>= inGroups ["appraisalscribe", "important"] >>= ghcjs_also
  ...
  _unix_time <-  (hackage (Just "0.3.6") "unix-time" {->>= flag (P.CabalDebian ["--no-run-tests"])-}) >>= debianize [] >>= inGroups ["authenticate", "important"] >>= ghcjs_also -- doctest assumes cabal build dir is dist
  _unixutils <-  (git "https://github.com/seereason/haskell-unixutils" []) >>= debianize [] >>= inGroups ["autobuilder-group", "important"] >>= ghcjs_also
  ...
  _utf8_string <- hackage (Just "1.0.1.1") "utf8-string" >>=
                  ...
                  debianize [] >>= ghcjs_also
  _utility_ht <- hackage (Just "0.0.11") "utility-ht" >>= debianize [] >>= ghcjs_also
...
{-
  _virthualenv <- pure $ P.Package { P._spec = Debianize'' (Patch (Hackage "virthualenv") $(embedFile "patches/virthualenv.diff")) Nothing
                                 ...
                                 , P._post = [] } :: TSt Package
-}
  _void <-  (hackage (Just "0.7.1") "void") >>= debianize [] >>= inGroups ["authenticate", "important"] >>= ghcjs_also
...
-}
  ...
  _webkit_sodium <- git "https://github.com/ghcjs/ghcjs-examples" [] >>= cd "webkit-sodium" >>= debianize [] >>= ghcjs_also >>= skip (Reason "skipped jsaddle")
  ...
  _wl_pprint_extras <- hackage (Just "3.5.0.5") "wl-pprint-extras" >>=
                       ...
                       debianize [] >>=
                       ghcjs_also
  _wl_pprint_text <-  (hackage (Just "1.1.0.4") "wl-pprint-text") >>= debianize [] >>= ghcjs_also
  ...
  _x509 <-  (hackage (Just "1.6.3") "x509") >>= debianize [] >>= inGroups ["authenticate", "important"] >>= ghcjs_also
  _x509_store <-  (hackage (Just "1.6.1") "x509-store") >>= debianize [] >>= inGroups ["authenticate", "important"] >>= ghcjs_also
  _x509_system <-  (hackage (Just "1.6.3") "x509-system") >>= debianize [] >>= inGroups ["authenticate", "important"] >>= ghcjs_also
  _x509_validation <- hackage (Just "1.6.3") "x509-validation" >>= debianize [] >>= inGroups ["authenticate", "important"] >>= ghcjs_also
  ...
  _xml <-  (hackage (Just "1.3.14") "xml") >>= debianize [] >>= ghcjs_also -- apt (rel release "wheezy" "quantal") "haskell-xml"
  ...
  _zlib <-  (hackage (Just "0.5.4.2") "zlib"
                      ...
                      >>= flag (P.DevelDep "zlib1g-dev")) >>= debianize [] >>= inGroups ["platform"] >>= ghcjs_also
