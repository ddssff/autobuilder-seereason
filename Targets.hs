...
{-  , Target { sourcePackageName = "haskell-cabal-install"
    ...
    , Target { sourcePackageName = "haskell-gnuplot"
            , sourceSpec = "deb-dir:(uri:http://hackage.haskell.org/packages/archive/gnuplot/0.3/gnuplot-0.3.tar.gz:4432a0e0b44ca7ceae8e6737cf0258fa):(darcs:http://src.seereason.com/debian/haskell-gnuplot)"
            , relaxInfo = [] }
