...
import Debian.AutoBuilder.Types.Packages as P (PackageFlag(CabalPin, DevelDep, DebVersion, BuildDep, CabalDebian, RelaxDep,
                                                           NoDoc, UDeb, SkipVersion), packageMap,
                                               pid, proc, groups, PackageId, hackage, debianize, flag, apply, patch,
                                               darcs, apt, git, cd, debdir, uri, release,
