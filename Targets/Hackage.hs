...
targets _home =
    ...
    , Target { sourcePackageName = "haskell-digestive-functors-happstack"
             , sourceSpec = "deb-dir:(uri:http://hackage.haskell.org/packages/archive/digestive-functors-happstack/0.1.0.1/digestive-functors-happstack-0.1.0.1.tar.gz:1c1b5a5c39d6ab604ca3176c4c2e1c69):(darcs:http://src.seereason.com/haskell-digestive-functors-happstack-debian)"
             , relaxInfo = [] }
    ...
    , Target { sourcePackageName = "haskell-happstack-ixset"
             ...
             , sourceSpec = "deb-dir:(uri:http://hackage.haskell.org/packages/archive/happstack-ixset/6.0.1/happstack-ixset-6.0.1.tar.gz:7222ad9711464b783de02f1c222134e1):(darcs:http://src.seereason.com/happstack-ixset-debian)"
             , relaxInfo = [] }
    , Target { sourcePackageName = "haskell-happstack-server"
             ...
             , sourceSpec = "deb-dir:(uri:http://hackage.haskell.org/packages/archive/happstack-server/6.1.5/happstack-server-6.1.5.tar.gz:ceff8378b3cb522f41a86cfe92511716):(darcs:" ++ repo ++ "/happstack-server-debian)"
             , relaxInfo = [] }
