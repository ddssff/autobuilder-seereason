...
buildTargets = do
  ...
  _happstack_ghcjs_client <-    git "ssh://git@github.com/seereason/happstack-ghcjs" [] >>= cd "happstack-ghcjs-client" >>= debianize >>= inGroups ["private-libs"] >>= ghcjs_flags >>= skip (Reason "Build failure")
  _happstack_ghcjs_server <-    git "ssh://git@github.com/seereason/happstack-ghcjs" [] >>= cd "happstack-ghcjs-server" >>= debianize >>= inGroups ["private-libs"]
  _ghcjs_ghcjs_webmodule <-     git "ssh://git@github.com/seereason/happstack-ghcjs" [] >>= cd "happstack-ghcjs-webmodule" >>= debianize >>= inGroups ["private-libs"] >>= ghcjs_flags
  _happstack_ghcjs_webmodule <- git "ssh://git@github.com/seereason/happstack-ghcjs" [] >>= cd "happstack-ghcjs-webmodule" >>= debianize
