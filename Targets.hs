...
--             , relaxInfo = [] }
    ...
    , Target { sourcePackageName = "haskell-nano"
             , sourceSpec = "deb-dir:(uri:http://hackage.haskell.org/packages/archive/nano/hmac-0.2.0/nano-hmac-0.2.0.tar.gz:2a127cca626aae030d6a8fabd2c391ef):(darcs:http://src.seereason.com/haskell-nano-debian)"
             , relaxInfo = [] }
