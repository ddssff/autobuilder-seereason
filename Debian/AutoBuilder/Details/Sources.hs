...
myUbuntuMirrorHost = "http://ubuntu.cs.utah.edu" -- sources line looks like: deb http://mirror.umd.edu/ubuntu/ trusty main restricted universe multiverse
...
--myUbuntuMirrorHost = "http://mirror.umd.edu"
