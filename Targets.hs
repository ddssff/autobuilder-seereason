...
{-  , Target { sourcePackageName = "haskell-happy"
    ...
    , Target { sourcePackageName = "haskell-monadlib"
             ...
             , relaxInfo = [] }
    , Target { sourcePackageName = "haskell-nano"
             , sourceSpec = "deb-dir:(uri:http://hackage.haskell.org/packages/archive/nano/hmac-0.2.0/nano-hmac-0.2.0.tar.gz:96e93a3a51be4d659f07a241dc171ff4):(darcs:http://src.seereason.com/haskell-nano-debian)"
             , relaxInfo = [] }
    , Target { sourcePackageName = "haskell-dataenc"
             , sourceSpec = "deb-dir:(uri:http://hackage.haskell.org/packages/archive/dataenc/0.13.0.3/dataenc-0.13.0.3.tar.gz:e141fb21140627776c3a8f52fa8d7513):(darcs:http://src.seereason.com/haskell-dataenc-debian)"
             , relaxInfo = [] }
