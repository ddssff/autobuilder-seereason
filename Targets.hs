...
{-  , Target { sourcePackageName = "haskell-happy"
    ...
    , Target { sourcePackageName = "haskell-sat"
             ...
             , relaxInfo = [] }
    , Target { sourcePackageName = "eclipseclp"
             , sourceSpec = "deb-dir:(uri:http://eclipseclp.org/Distribution/6.0_158/src/eclipse_src.tgz:a01907438e16e3682d43af1d77e5885c):(darcs:http://src.seereason.com/eclipseclp-debian)"
             , relaxInfo = [] }
