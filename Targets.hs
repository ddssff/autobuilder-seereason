...
--             , relaxInfo = [] }
    ...
    , Target { sourcePackageName = "haskell-instant-generics"
             , sourceSpec = "deb-dir:(uri:http://hackage.haskell.org/packages/archive/instant-generics/0.2.1/instant-generics-0.2.1.tar.gz:b6a37bfa18b054800ca8c5ce5dbe4e87):(darcs:http://src.seereason.com/haskell-instant-generics-debian)"
             , relaxInfo = [] }
