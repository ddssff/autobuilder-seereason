...
--             , relaxInfo = [] }
    , Target { -- Yes, if you build ghc7 the resulting compiler package name is ghc6.
             ...
             , sourceSpec =
                ...
                -- GHC7 -> "proc:deb-dir:(uri:http://www.haskell.org/ghc/dist/7.0.2-rc2/ghc-7.0.1.20110217-src.tar.bz2:fe892289799c3ef3513afb35bd91b490):(darcs:" ++ repo ++ "/ghc7-debian)"
                   GHC7 -> "proc:deb-dir:(uri:http://www.haskell.org/ghc/dist/7.0.2/ghc-7.0.2-src.tar.bz2:946a18a0dc30437db72c0d3fdf26ca42):(darcs:" ++ repo ++ "/ghc7-debian)"
             , relaxInfo = ["ghc6"
                           ,"happy"
                           ,"alex"
                           ,"xsltproc"
    ...
    , Target { sourcePackageName = "haskell-digestive-functors"
             , sourceSpec =
                 "deb-dir:(uri:http://hackage.haskell.org/packages/archive/digestive-functors/0.1.0.0/digestive-functors-0.1.0.0.tar.gz:ca2d55dc58ef8b5a19990f944a0300d4):(darcs:http://src.seereason.com/haskell-digestive-functors-debian)"
             , relaxInfo = [] }
    ...
    , Target { sourcePackageName = "haskell-happstack"
             ...
             , sourceSpec = "deb-dir:(uri:http://hackage.haskell.org/packages/archive/happstack/6.0.0/happstack-6.0.0.tar.gz:dfc0fbb9b85b759fb1e61063373fa6d8):(darcs:" ++ repo ++ "/happstack-debian)"
             , relaxInfo = [] }
    ...
    , Target { sourcePackageName = "haskell-happstack-data"
             ...
             , sourceSpec = "deb-dir:(uri:http://hackage.haskell.org/packages/archive/happstack-data/6.0.0/happstack-data-6.0.0.tar.gz:be72c4c11d1317bf52c80782eac28a2d):(darcs:" ++ repo ++ "/happstack-data-debian)"
             , relaxInfo = [] }
    ...
    , Target { sourcePackageName = "haskell-happstack-ixset"
             ...
             , sourceSpec = "deb-dir:(uri:http://hackage.haskell.org/packages/archive/happstack-ixset/6.0.0/happstack-ixset-6.0.0.tar.gz:4353295433c22c44524d520e209c6511):(darcs:" ++ repo ++ "/happstack-ixset-debian)"
             , relaxInfo = [] }
    , Target { sourcePackageName = "haskell-happstack-server"
             ...
             , sourceSpec = "deb-dir:(uri:http://hackage.haskell.org/packages/archive/happstack-server/6.0.0/happstack-server-6.0.0.tar.gz:65b7f11f70b5c549b80b36a32436c8f9):(darcs:" ++ repo ++ "/happstack-server-debian)"
             , relaxInfo = [] }
    , Target { sourcePackageName = "haskell-happstack-state"
             ...
             , sourceSpec = "deb-dir:(uri:http://hackage.haskell.org/packages/archive/happstack-state/6.0.0/happstack-state-6.0.0.tar.gz:c625f04118c4701e632eb9acc85148de):(darcs:" ++ repo ++ "/happstack-state-debian)"
             , relaxInfo = [] }
    , Target { sourcePackageName = "haskell-happstack-util"
             ...
             , sourceSpec = "deb-dir:(uri:http://hackage.haskell.org/packages/archive/happstack-util/6.0.0/happstack-util-6.0.0.tar.gz:0839c54a7bb415d57e44a5d044562278):(darcs:" ++ repo ++ "/happstack-util-debian)"
             , relaxInfo = [] }
    -- Depends on pandoc
...
-}
    ...
    , Target { sourcePackageName = "haskell-sendfile"
             , sourceSpec = "deb-dir:(uri:http://hackage.haskell.org/packages/archive/sendfile/0.7.2/sendfile-0.7.2.tar.gz:7e59a3c47ead59ad19c72ee1fcef9fa6):(darcs:" ++ repo ++ "/haskell-sendfile-debian)"
--           , sourceSpec = "deb-dir:(darcs:http://patch-tag.com/r/mae/sendfile/pullrepo):(darcs:http://src.seereason.com/debian/haskell-sendfile-debian)"
    ...
    , Target { sourcePackageName = "haskell-syb-with-class-instances-text"
             , sourceSpec = "deb-dir:(darcs:http://src.seereason.com/syb-with-class-instances-text):(darcs:" ++ repo ++ "/syb-with-class-instances-text-debian)"
             , relaxInfo = [] }      
...
-}
    ...
    , Target { sourcePackageName = "haskell-unix-compat"
             , sourceSpec = "deb-dir:(uri:http://hackage.haskell.org/packages/archive/unix-compat/0.1.2.1/unix-compat-0.1.2.1.tar.gz:6ecfc3922fce2e96922af3a636b061f9):(darcs:" ++ repo ++ "/haskell-unix-compat-debian)"
             , relaxInfo = [] }
...
{-  -- Compile error at the moment, but this package is not a current priority.
    ...
    , Target { sourcePackageName = "haskell-seereason"
             , sourceSpec = "darcs:" ++ ghcPrivateRepo ++ "/seereason"
             , relaxInfo = [] }
