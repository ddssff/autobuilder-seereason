...
{-    , Target { sourcePackageName = "gmp"
    ...
    , Target { sourcePackageName = "haskell-happstackdotcom"
             ...
             , sourceSpec = "darcs:http://src.seereason.com/happstackDotCom"
             , relaxInfo = [] }
    ...
    , Target { sourcePackageName = "haskell-src-exts"
             , sourceSpec = "quilt:(apt:" ++ sid ++ ":haskell-src-exts=1.9.0-2):(darcs:http://src.seereason.com/haskell-src-exts-quilt)"
             , relaxInfo = [] }      
...
-}
    ...
    , Target { sourcePackageName = "haskell-web-routes"
             -- , sourceSpec = "apt:sid:haskell-web-routes" -- sid version too old (0.23-4, our darcs has 0.24.1)
...
privateTargets home =
    [ Target { sourcePackageName = "haskell-filecache"
             , sourceSpec = "darcs:http://src.seereason.com/haskell-filecache"
             , relaxInfo = [] }
    , Target { sourcePackageName = "haskell-document"
             , sourceSpec = "darcs:http://src.seereason.com/haskell-document"
             , relaxInfo = [] }
    , Target { sourcePackageName = "haskell-appraisal"
             , sourceSpec = "darcs:http://src.seereason.com/artvaluereport"
             , relaxInfo = [] }
    , Target { sourcePackageName = "haskell-happstack-mailinglist"
             , sourceSpec = "darcs:http://src.seereason.com/mailingList"
             , relaxInfo = [] }
    , Target { sourcePackageName = "haskell-generic-formlets3"
             , sourceSpec = "darcs:http://src.seereason.com/generic-formlets3"
             , relaxInfo = [] }
    , Target { sourcePackageName = "haskell-ontology"
             , sourceSpec = "darcs:http://src.seereason.com/haskell-ontology"
             , relaxInfo = [] }
...
{-  -- Compile error at the moment, but this package is not a current priority.
    ...
    , Target { sourcePackageName = "haskell-seereason"
             , sourceSpec = "darcs:http://src.seereason.com/seereason"
             , relaxInfo = [] }
    , Target { sourcePackageName = "haskell-creativeprompts"
             , sourceSpec = "darcs:http://src.seereason.com/creativeprompts"
             , relaxInfo = [] }
    , Target { sourcePackageName = "prefeteria"
             , sourceSpec = "darcs:http://src.seereason.com/prefeteria"
             , relaxInfo = [] }
    ]
