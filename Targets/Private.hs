...
applications _home =
    ...
    , P.Package { P.name = "haskell-appraisal-data"
                , P.spec = Cd "data" (Darcs (privateRepo ++ "/artvaluereport") Nothing)
                , P.flags = [] }
    ...
    , P.Package { P.name = "haskell-happstack-ontology"
                , P.spec = Cd "ontology" (Darcs (privateRepo ++ "/seereason") Nothing)
                , P.flags = [] }
    , P.Package { P.name = "haskell-scaffolding"
                , P.spec = Cd "scaffolding" (Darcs (privateRepo ++ "/seereason") Nothing)
                , P.flags = [] }
