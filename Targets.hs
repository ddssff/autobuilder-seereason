...
{-  -- Something is broken in the archive maybe
    ...
    , Target { sourcePackageName="haskell-data-accessor"
             , sourceSpec="deb-dir:(uri:http://hackage.haskell.org/packages/archive/data-accessor/0.2.1.4/data-accessor-0.2.1.4.tar.gz:23d37d1d5345588f849a9cffcb40fab8):(darcs:http://src.seereason.com/haskell-data-accessor-debian)"
             , relaxInfo = [] }
    ...
    , Target { sourcePackageName="haskell-syb"
             , sourceSpec="deb-dir:(uri:http://code.haskell.org/syb/syb-0.2-rc1.tar.gz:2c3cc88aeee083f1805a1992fb5cfb01):(darcs:http://src.seereason.com/debian/haskell-syb-debian)"
             , relaxInfo = [] }
    ...
    , Target { sourcePackageName = "haskell-logic-tptp"
             , sourceSpec = "deb-dir:(uri:http://hackage.haskell.org/packages/archive/logic-TPTP/0.2.0/logic-TPTP-0.2.0.tar.gz:e41894cb4e58d0e5740cdf39428cb402):(darcs:http://src.seereason.com/logic-TPTP-debian)"
             , relaxInfo = [] }
