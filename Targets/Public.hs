    ...
    , P.Package { P.name = "haskell-pandoc"
                , P.spec = Debianize (Patch
                                      ...
                                      (unlines
                                       ...
                                       , "-                 time >= 1.2 && < 1.5"
                                       , "+                 time >= 1.2 && < 1.5,"
                                       , "+                 blaze-html, blaze-markup, bytestring, containers, extensible-exceptions,"
                                       , "+                 highlighting-kate, HTTP, json, mtl, network, old-locale, pandoc-types,"
                                       , "+                 parsec, random, syb, tagsoup, texmath, utf8-string, xml, zip-archive"
